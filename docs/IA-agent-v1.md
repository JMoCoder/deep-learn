# Quantum IA — Agent v1.3.1

Locked information architecture for the first PWA slice. Native clients come later; this document is the product contract for `packages/web`.
...
| Books | **书籍** | Current-topic body + notes; topic history |
...
- Outline navigation updates the projected section and the packed agent context (`outline_position`).

## 书籍

Body of the **current topic only**, plus the notes the agent has already appended.

### Topic switcher

- Opens from the **RIGHT** (v1.3.1).
